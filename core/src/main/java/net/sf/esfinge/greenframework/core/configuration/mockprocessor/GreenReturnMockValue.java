...
public class GreenReturnMockValue {
    ...
    public Object getReturnValue(Method method, GreenSwitchConfiguration configuration) {
    ...
    private Object processReturnMockValue(Method method, GreenDefaultReturn greenDefaultReturn, GreenSwitchConfiguration configuration) {
        if (String.class.equals(method.getReturnType())) {
            return getStrMockValue(greenDefaultReturn, configuration);
        } else if (Integer.class.equals(method.getReturnType())) {
            return getIntMockValue(greenDefaultReturn, configuration);
        } else if (method.getReturnType().equals(Void.TYPE)) {
            return null;
        } else if (Long.class.equals(method.getReturnType())) {
            return Optional.ofNullable(getIntMockValue(greenDefaultReturn, configuration))
                    .map(Long::valueOf)
                    .orElse(null);
        }
        return null;
