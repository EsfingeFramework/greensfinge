...
import net.sf.esfinge.greenframework.configuration.esfinge.annotation.GreenReadAttributesAnnotation;
import net.sf.esfinge.greenframework.configuration.esfinge.annotation.GreenReadFieldClassAnnotation;
